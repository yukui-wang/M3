...
#import "XZTaskMsgDataCell.h"
#import "XZTaskMsgData.h"

@implementation XZTaskMsgDataCell
- (void)dealloc {
...
- (void)customLayoutSubviewsFrame:(CGRect)frame {
    ...
    [_timeLabel setFrame:CGRectMake(45, CGRectGetMaxY(_titleLabel.frame)+4, self.width-50, FONTSYS(14).lineHeight)];
}

- (void)setMsgData:(XZTaskMsgData *)msgData {
