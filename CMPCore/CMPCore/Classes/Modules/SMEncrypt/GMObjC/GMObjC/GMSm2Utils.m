...
//    NSString *s1 = [GMUtils base64Encode:plainData];
//    plainData = [s1 dataUsingEncoding:NSUTF8StringEncoding];
...
+ (nullable NSString *)decryptToText:(NSString *)ciphertext privateKey:(NSString *)privateKey{
    ...
    //base64解码
//    NSString *decryptedStr1 = [[NSString alloc]initWithData:[GMUtils base64Decode:decryptedStr] encoding:NSUTF8StringEncoding];
