//
//  CMPRCShakeWinMessage.m
//  M3
//
//  Created by 曾祥洁 on 2018/10/8.
//
...
@implementation CMPRCShakeWinMessage

+ (instancetype)messageWithContent:(NSString *)content {
    
    CMPRCShakeWinMessage *text = [[CMPRCShakeWinMessage alloc] init];
    if (text) {
