...
@interface CMPRCUrgeMessageCell () {
...
@implementation CMPRCUrgeMessageCell

+ (CGSize)sizeForMessageModel:(RCMessageModel *)model
      withCollectionViewWidth:(CGFloat)collectionViewWidth
         referenceExtraHeight:(CGFloat)extraHeight {
    
    CGSize size = [CMPRCUrgeMessageCell getBubbleBackgroundViewSize];
...
- (void)initialize {
    ...
    if (!_contentLabel) {
        ...
        //        [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapTextMessage:)] autorelease];
        //        textMessageTap.numberOfTapsRequired = 1;
        //        textMessageTap.numberOfTouchesRequired = 1;
        //        [_contentLabel addGestureRecognizer:textMessageTap];
...
- (void)setDataModel:(RCMessageModel *)model {
    ...
    CMPRCUrgeMessage *message = (CMPRCUrgeMessage *)model.content;
    ...
    if (![NSString isNull:message.sendName]) {
        _senderLabel.text = message.sendName;
    }
...
- (void)setAutoLayout{
    ...
    if (MessageDirection_RECEIVE == self.messageDirection) {
        ...
        [_senderLabel setFrame:CGRectMake(16, 90, 120,_senderLabel.font.lineHeight)];
        [_timeLabel setFrame:CGRectMake(136, 90, 120,_timeLabel.font.lineHeight)];
        ...
        [_senderLabel setFrame:CGRectMake(10, 90, 120,_senderLabel.font.lineHeight)];
        [_timeLabel setFrame:CGRectMake(130, 90, 120,_timeLabel.font.lineHeight)];
        _bubbleBackgroundView.frame = CGRectMake(0, 0, bubbleBackgroundViewSize.width, bubbleBackgroundViewSize.height);
