...
@interface SyPoiSearchResult : NSObject
...
@interface SyRouteCity : NSObject
...
@interface SyRouteSearchResult : NSObject
...
@property(nonatomic,retain) NSArray*  routes;     //SYRoute对象数组，存储返回的路段信息
@property(nonatomic,retain) NSString* length;     //导航距离
@property(nonatomic,retain) NSArray* viaCities;   //途经城市 SYRouteCity对象数组
@end


@interface SyDistanceSearchResult : NSObject
...
@interface SyBus : NSObject
@property(nonatomic,retain) NSArray* segmentArray; //SYSegment对象序列
...
@interface SyBusRouteSearchResult : NSObject
@property(nonatomic,assign) NSInteger count;      //导航段数
@property(nonatomic,retain) NSString* searchtime; //查询时间
@property(nonatomic,retain) NSArray*  routes;//SYBus数组,用来存储SYBus对象序列
@end


@interface SyBusLine : NSObject
...
@property(nonatomic,retain) NSString* desc; //线路备注信息
...
@interface SyBusLineSearchResult : NSObject
@property(nonatomic,retain) NSArray* busLineArray;//SYBusline对象的序列
...
@interface SyRGCItem : NSObject
@property(nonatomic,retain) NSString* x; //偏移后的经度坐标
@property(nonatomic,retain) NSString* y; //偏移后的纬度坐标
@end

@interface SyRGCSearchResult : NSObject
@property(nonatomic,retain) NSArray* rgcItemArray;//返回的SYRGCItem对象的序列
@end

@interface SyGeoPOI : NSObject
@property(nonatomic,retain) NSString* name; //名称
@property(nonatomic,retain) NSString* level; //等级
@property(nonatomic,assign) double x;     //经度坐标
@property(nonatomic,assign) double y;     //纬度坐标
...
@interface SyGeoCodingSearchResult : NSObject
@property(nonatomic,assign) NSInteger count; //返回的记录条数
@property(nonatomic,retain) NSMutableArray * geoCodingArray; //返回的地理兴趣点(SYGeoPOI对象)队列
@end
...
@interface SyReverseGeocodingInfo : NSObject
@property(nonatomic,retain) SyProvince* province;//省份信息
@property(nonatomic,retain) SyCity* city;//城市信息
@property(nonatomic,retain) SyDistrict* district;//区信息
@property(nonatomic,retain) NSArray* roads;//道路信息 SYRoad对象队列
@property(nonatomic,retain) NSArray* pois;//poi信息 SYPOI对象队列
@property(nonatomic,retain) NSArray* crosses;//道路交叉口信息
@end


@interface SyReverseGeocodingSearchResult : NSObject
@property(nonatomic,retain) NSArray* resultArray; //返回的SYReverseGeocodingResult对象序列
@end

@interface SySpasSearchResult : NSObject
@property(nonatomic,assign) NSInteger count;  //允许返回记录数与用户权限有关系
@property(nonatomic,assign) NSInteger record; //当前返回记录数
@property(nonatomic,assign) NSInteger total;  //总记录数
@property(nonatomic,retain) NSArray* poiArray; //poi 的数组
@property(nonatomic,retain) NSArray* suggestionArray;  //查询关键字的建议
@end
