...
@property (nonatomic, retain) NSMutableArray *models;                  ///< All photo models / 所有图片模型数组
@property (nonatomic, retain) NSMutableArray *photos;                  ///< All photos  / 所有图片数组
...
@property (nonatomic, copy) void (^doneButtonClickBlockCropMode)(NSString *path);
