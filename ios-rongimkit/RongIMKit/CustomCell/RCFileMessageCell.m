...
+ (CGSize)sizeForMessageModel:(RCMessageModel *)model
    ...
    CGFloat __messagecontentview_height = 69.f;
...
- (void)initialize {
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_nameLabel, _sizeLabel, _typeIconView, _progressView);

    [self.bubbleBackgroundView
        addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-10-[_typeIconView(49)]"
                                                               options:0
                                                               metrics:nil
                                                                 views:views]];
    [self.bubbleBackgroundView
        addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[_typeIconView(49)]-10-[_nameLabel]-10-|"
                                                               options:0
                                                               metrics:nil
                                                                 views:views]];
    [self.bubbleBackgroundView
        addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-10-[_nameLabel(<=37)]"
                                                               options:0
                                                               metrics:nil
                                                                 views:views]];
    [self.bubbleBackgroundView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_sizeLabel(12)]-10-|"
                                                                                      options:0
                                                                                      metrics:nil
                                                                                        views:views]];
    [self.bubbleBackgroundView
        addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[_typeIconView]-10-[_sizeLabel]"
                                                               options:0
                                                               metrics:nil
                                                                 views:views]];

    [self.bubbleBackgroundView
        addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_progressView(1)]-5-|"
                                                               options:0
                                                               metrics:nil
                                                                 views:views]];
    [self.bubbleBackgroundView
        addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[_progressView]-17-|"
                                                               options:0
                                                               metrics:nil
                                                                 views:views]];
...
//    NSString *fileTypeIcon = [RCKitUtility getFileTypeIcon:fileMessage.type];
    NSString *fileTypeIcon = [RCKitUtility getFileTypeIcon:fileMessage.name.pathExtension];
    //edit by chengkun end
    self.typeIconView.image = [RCKitUtility imageNamed:fileTypeIcon ofBundle:@"RongCloud.bundle"];
    [self setAutoLayout];
}
...
- (void)setAutoLayout {
    ...
    messageContentViewRect.size.height = 69;
    ...
    if (MessageDirection_RECEIVE == self.messageDirection) {
        ...
        self.messageContentConstraint = [NSMutableArray
        ...
        [self.messageContentConstraint
            addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-18-[_typeIconView]"
                                                                        options:0
                                                                        metrics:nil
                                                                          views:NSDictionaryOfVariableBindings(
                                                                                    _nameLabel, _sizeLabel,
                                                                                    _typeIconView, _progressView)]];
    } else {
        [self.cancelSendButton removeFromSuperview];
        self.progressView.hidden = YES;
        ...
        self.messageContentView.frame = messageContentViewRect;
        self.bubbleBackgroundView.image = [RCKitUtility imageNamed:@"chat_to_bg_white" ofBundle:@"RongCloud.bundle"];
        UIImage *image = self.bubbleBackgroundView.image;
        self.bubbleBackgroundView.image = [self.bubbleBackgroundView.image
        ...
        [self.messageContentConstraint
            addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-12-[_typeIconView]"
                                                                        options:0
                                                                        metrics:nil
                                                                          views:NSDictionaryOfVariableBindings(
                                                                                    _nameLabel, _sizeLabel,
...
- (void)displayCancelLabel {
    ...
    [self.messageContentConstraint
        addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[_cancelLabel]-16.5-|"
                                                                    ...
                                                                    metrics:nil
                                                                      views:NSDictionaryOfVariableBindings(
                                                                                _nameLabel, _sizeLabel, _typeIconView,
                                                                                _progressView, _cancelLabel)]];
    [self.bubbleBackgroundView addConstraint:[NSLayoutConstraint constraintWithItem:_cancelLabel
