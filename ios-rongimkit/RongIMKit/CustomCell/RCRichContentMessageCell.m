...
+ (CGSize)sizeForMessageModel:(RCMessageModel *)model
    ...
    CGSize _titleLabelSize =
        [RCKitUtility getTextDrawingSize:richContentMsg.title
                                    font:[UIFont systemFontOfSize:RichContent_Title_Font_Size]
                         constrainedSize:CGSizeMake((int)(collectionViewWidth * 0.637) - 24, MAXFLOAT)];
...
- (void)initialize {
    ...
    self.digestLabel.textColor = RCDYCOLOR(0x888888, 0xc3c3c3);
...
- (void)setDataModel:(RCMessageModel *)model {
    ...
    CGSize _titleLabelSize =
        [RCKitUtility getTextDrawingSize:richContentMsg.title
                                    font:[UIFont systemFontOfSize:RichContent_Title_Font_Size]
                         constrainedSize:CGSizeMake(messageContentViewRect.size.width - RICH_CONTENT_PADDING_LEFT -
                                                        RICH_CONTENT_PADDING_RIGHT,
                                                    MAXFLOAT)];

    CGSize _digestLabelSize = [RCKitUtility
        getTextDrawingSize:richContentMsg.digest
                      font:[UIFont systemFontOfSize:RichContent_Message_Font_Size]
           constrainedSize:CGSizeMake(messageContentViewRect.size.width - richContentThumbImageFrame.width -
    ...
    if (MessageDirection_RECEIVE == self.messageDirection) {
        ...
        self.titleLabel.frame = CGRectMake(RICH_CONTENT_PADDING_LEFT + 7, RICH_CONTENT_TITLE_PADDING_TOP,
                                           self.messageContentView.frame.size.width - RICH_CONTENT_PADDING_LEFT -
                                               RICH_CONTENT_PADDING_RIGHT + 1,
                                           _titleLabelSize.height);
        self.digestLabel.frame = CGRectMake(
            RICH_CONTENT_PADDING_LEFT + 7, CGRectGetMaxY(self.titleLabel.frame) + RICH_CONTENT_TITLE_CONTENT_PADDING,
            messageContentViewRect.size.width - 6 - RICH_CONTENT_PADDING_LEFT - RICH_CONTENT_PADDING_RIGHT -
                RICH_CONTENT_THUMBNAIL_WIDTH - RICH_CONTENT_THUMBNAIL_CONTENT_PADDING,
            _digestLabelSize.height);
        self.richContentImageView.frame = CGRectMake(
            CGRectGetMaxX(self.bubbleBackgroundView.frame) - 12.5 - 45, CGRectGetMinY(self.digestLabel.frame) - 2,
        ...
        self.titleLabel.frame = CGRectMake(RICH_CONTENT_PADDING_LEFT, RICH_CONTENT_TITLE_PADDING_TOP,
                                           self.messageContentView.frame.size.width - RICH_CONTENT_PADDING_LEFT -
                                               RICH_CONTENT_PADDING_RIGHT,
                                           _titleLabelSize.height);
        self.digestLabel.frame = CGRectMake(
            RICH_CONTENT_PADDING_LEFT, CGRectGetMaxY(self.titleLabel.frame) + RICH_CONTENT_TITLE_CONTENT_PADDING,
            messageContentViewRect.size.width - RICH_CONTENT_PADDING_LEFT - 6 - RICH_CONTENT_PADDING_RIGHT -
                RICH_CONTENT_THUMBNAIL_WIDTH - RICH_CONTENT_THUMBNAIL_CONTENT_PADDING,
            _digestLabelSize.height);
        self.richContentImageView.frame = CGRectMake(
            CGRectGetMaxX(self.bubbleBackgroundView.frame) - 7 - 12.5 - 45, CGRectGetMinY(self.digestLabel.frame) - 2,
            richContentThumbImageFrame.width, richContentThumbImageFrame.height);
        UIImage *image = self.bubbleBackgroundView.image;
        self.bubbleBackgroundView.image = [self.bubbleBackgroundView.image
