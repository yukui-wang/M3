...
@interface RCConversationSettingTableViewHeader () <RCConversationSettingTableViewHeaderItemDelegate>
...
- (instancetype)init {
    CGRect tempRect = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 120);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    RCConversationSettingTableViewHeaderItem *cell =
        [collectionView dequeueReusableCellWithReuseIdentifier:@"RCConversationSettingTableViewHeaderItem"
    ...
    if (self.users.count && (self.users.count - 1 >= indexPath.row)) {
        ...
        [cell.ivAva setImage:[RCKitUtility imageNamed:@"add_members" ofBundle:@"RongCloud.bundle"]];

    } else {
        cell.btnImg.hidden = YES;
        cell.gestureRecognizers = nil;
        cell.titleLabel.text = @"";
        [cell.ivAva setImage:[RCKitUtility imageNamed:@"delete_members" ofBundle:@"RongCloud.bundle"]];
        //长按显示减号
        UILongPressGestureRecognizer *longPressGestureRecognizer =
            [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(showDeleteTip:)];
        longPressGestureRecognizer.minimumPressDuration = 0.28;
...
- (void)hidesDeleteTip:(UITapGestureRecognizer *)recognizer {
    if (self.showDeleteTip) {
        ...
        if (self.settingTableViewHeaderDelegate &&
            ...
            RCConversationSettingTableViewHeaderItem *cell =
                (RCConversationSettingTableViewHeaderItem *)recognizer.view;
