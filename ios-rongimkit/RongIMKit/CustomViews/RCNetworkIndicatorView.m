...
- (instancetype)initWithText:(NSString *)text {
    ...
    if (self) {
        ...
        self.networkUnreachableDescriptionLabel.textColor = RCDYCOLOR(0x776868, 0xF76260);
        ...
        self.lineView.backgroundColor = RCDYCOLOR(0xeccecd, 0x262626);
        ...
        NSDictionary *bindingViews = NSDictionaryOfVariableBindings(_networkUnreachableImageView,
                                                                    _networkUnreachableDescriptionLabel, _lineView);
        ...
        [self addConstraints:[NSLayoutConstraint
                                 constraintsWithVisualFormat:@"H:|-19-[_networkUnreachableImageView(26)]-20-[_"
                                                     ...
                                                     metrics:nil
                                                       views:bindingViews]];
        [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_networkUnreachableImageView(26)]"
                                                                     options:0
                                                                     metrics:nil
                                                                       views:bindingViews]];

        [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_lineView]|"
                                                                     options:0
                                                                     metrics:nil
                                                                       views:bindingViews]];
        [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_lineView(0.5)]|"
                                                                     options:0
                                                                     metrics:nil
                                                                       views:bindingViews]];
