...
- (void)setup {
    ...
    CGSize labelsize =
        [NSLocalizedStringFromTable(@"Search", @"RongCloudKit", nil) sizeWithFont:font
                                                                constrainedToSize:size
                                                                    lineBreakMode:NSLineBreakByCharWrapping];
#else
    CGSize labelsize = [RCKitUtility getTextDrawingSize:NSLocalizedStringFromTable(@"Search", @"RongCloudKit", nil)
                                                   font:font
