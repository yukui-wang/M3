...
- (instancetype)initWithFrame:(CGRect)frame reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.headerLabel.font = [UIFont systemFontOfSize:RCPublicServiceMultiImgTxtCellHeaderCellTextFont];
...
- (void)setRichContent:(RCRichContentMessage *)richContent {
    ...
    CGSize labelsize =
        [RCKitUtility getTextDrawingSize:_richContent.title
                                    font:[UIFont systemFontOfSize:RCPublicServiceMultiImgTxtCellHeaderCellTextFont]
