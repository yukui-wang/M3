...
- (instancetype)initWithDelegate:(id<RCRobotEvaluationViewDelegate>)delegate {
    ...
    if (self) {
        ...
        [self setButtonTitles:[NSMutableArray
                                  arrayWithObjects:NSLocalizedStringFromTable(@"Submit", @"RongCloudKit", nil),
                                                   NSLocalizedStringFromTable(@"Cancel", @"RongCloudKit", nil), nil]];
...
- (UIButton *)yesButton {
    if (!_yesButton) {
        ...
        [_yesButton setBackgroundImage:[RCKitUtility imageNamed:(@"custom_service_evaluation_yes_hover")
                                                       ofBundle:@"RongCloud.bundle"]
                              forState:UIControlStateSelected];
        [_yesButton
            setBackgroundImage:[RCKitUtility imageNamed:(@"custom_service_evaluation_yes") ofBundle:@"RongCloud.bundle"]
...
- (UIButton *)noButton {
    if (!_noButton) {
        ...
        [_noButton setBackgroundImage:[RCKitUtility imageNamed:(@"custom_service_evaluation_no_hover")
                                                      ofBundle:@"RongCloud.bundle"]
                             forState:UIControlStateSelected];
        [_noButton
            setBackgroundImage:[RCKitUtility imageNamed:(@"custom_service_evaluation_no") ofBundle:@"RongCloud.bundle"]
                      forState:UIControlStateNormal];
