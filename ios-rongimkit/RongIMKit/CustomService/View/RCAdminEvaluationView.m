...
- (UIButton *)starAtIndex:(int)index {
    ...
    [starButton
        setBackgroundImage:[RCKitUtility imageNamed:(@"custom_service_star_selected") ofBundle:@"RongCloud.bundle"]
...
- (void)setStarValue:(int)starValue {
    ...
    for (int i = 0; i < STAR_COUNT; i++) {
        ...
        if (i <= starValue) {
            [btn setBackgroundImage:[RCKitUtility imageNamed:(@"custom_service_evaluation_star_hover")
                                                    ofBundle:@"RongCloud.bundle"]
                           forState:UIControlStateNormal];
        } else {
            [btn setBackgroundImage:[RCKitUtility imageNamed:(@"custom_service_evaluation_star")
                                                    ofBundle:@"RongCloud.bundle"]
                           forState:UIControlStateNormal];
        }
    }
