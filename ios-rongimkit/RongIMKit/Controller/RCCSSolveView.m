...
- (void)setupSubviews {
    ...
    [self.solved setBackgroundImage:[RCKitUtility imageNamed:@"Resolved" ofBundle:@"RongCloud.bundle"]
                           forState:UIControlStateNormal];
    [self.solved setBackgroundImage:[RCKitUtility imageNamed:@"Resolved-hover" ofBundle:@"RongCloud.bundle"]
    ...
    [self.solving setBackgroundImage:[RCKitUtility imageNamed:@"follow" ofBundle:@"RongCloud.bundle"]
                            forState:UIControlStateNormal];
    [self.solving setBackgroundImage:[RCKitUtility imageNamed:@"follow-hover" ofBundle:@"RongCloud.bundle"]
                            forState:UIControlStateSelected];
    ...
    [self.noSolve setBackgroundImage:[RCKitUtility imageNamed:@"noSolve" ofBundle:@"RongCloud.bundle"]
                            forState:UIControlStateNormal];
    [self.noSolve setBackgroundImage:[RCKitUtility imageNamed:@"noSolve-hover" ofBundle:@"RongCloud.bundle"]
                            forState:UIControlStateSelected];
    self.noSolve.layer.cornerRadius = 5;
