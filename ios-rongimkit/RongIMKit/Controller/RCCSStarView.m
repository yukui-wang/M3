...
- (instancetype)initWithFrame:(CGRect)startFrame
    ...
    if (self) {
        ...
        if (defaultImage) {
            ...
            self.defaultImage =
                [RCKitUtility imageNamed:(@"custom_service_evaluation_star") ofBundle:@"RongCloud.bundle"];
        }
        ...
        if (lightImage) {
            ...
            self.lightImage =
                [RCKitUtility imageNamed:(@"custom_service_evaluation_star_hover") ofBundle:@"RongCloud.bundle"];
        }
