...
- (void)setupSubviews:(BOOL)isShowEva {
    ...
    [self.cancelButton setBackgroundImage:[RCKitUtility imageNamed:@"close" ofBundle:@"RongCloud.bundle"]
    ...
    [self.submitButton setBackgroundImage:[RCKitUtility imageNamed:@"blue" ofBundle:@"RongCloud.bundle"]
                                 forState:UIControlStateNormal];
    [self.submitButton setBackgroundImage:[RCKitUtility imageNamed:@"blue－hover" ofBundle:@"RongCloud.bundle"]
