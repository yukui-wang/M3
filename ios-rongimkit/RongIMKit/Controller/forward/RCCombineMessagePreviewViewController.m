...
- (UIImageView *)loadingImageView {
    if (!_loadingImageView) {
        ...
        _loadingImageView.image = [RCKitUtility imageNamed:@"combine_loading" ofBundle:@"RongCloud.bundle"];
    }
...
- (UILabel *)loadingLabel {
    if (!_loadingLabel) {
        ...
        _loadingLabel.text = NSLocalizedStringFromTable(@"CombineMessageLoading", @"RongCloudKit", nil);
    }
...
- (UIImageView *)loadFailedImageView {
    if (!_loadFailedImageView) {
        ...
        _loadFailedImageView.image = [RCKitUtility imageNamed:@"combine_failed" ofBundle:@"RongCloud.bundle"];
...
- (UILabel *)loadFailedLabel {
    if (!_loadFailedLabel) {
        ...
        _loadFailedLabel.font = [UIFont systemFontOfSize:15];
        ...
        _loadFailedLabel.text = NSLocalizedStringFromTable(@"CombineMessageLoadFailed", @"RongCloudKit", nil);
    }
