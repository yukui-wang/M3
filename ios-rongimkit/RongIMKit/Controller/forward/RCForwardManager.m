...
- (NSString *)packageHTMLBody:(RCMessageModel *)model
    ...
    if ([model.objectName isEqualToString:RCTextMessageTypeIdentifier]) {
        ...
        templateString = [self generateCommonString:NSLocalizedStringFromTable(@"RC:VcMsg", @"RongCloudKit", nil)
                                           userInfo:userInfo
                                           sentTime:model.sentTime
                                    ifSplitPortrait:(BOOL)ifSplitPortrait
                                            htmlKey:RCVoiceMessageTypeIdentifier];
    } else if ([model.objectName isEqualToString:@"RC:ImgTextMsg"]) {
        templateString = [self generateCommonString:NSLocalizedStringFromTable(@"RC:ImgTextMsg", @"RongCloudKit", nil)
                                           userInfo:userInfo
                                           sentTime:model.sentTime
                                    ifSplitPortrait:ifSplitPortrait
                                            htmlKey:@"RC:ImgTextMsg"];
    } else if ([model.objectName isEqualToString:@"RC:VCSummary"]) {
        templateString = [self generateCommonString:NSLocalizedStringFromTable(@"RC:VCSummary", @"RongCloudKit", nil)
                                           userInfo:userInfo
                                           sentTime:model.sentTime
                                    ifSplitPortrait:ifSplitPortrait
                                            htmlKey:@"RC:VCSummary"];
    } else if ([model.objectName isEqualToString:@"RC:StkMsg"]) {
        templateString = [self generateCommonString:NSLocalizedStringFromTable(@"RC:StkMsg", @"RongCloudKit", nil)
                                           userInfo:userInfo
                                           sentTime:model.sentTime
                                    ifSplitPortrait:ifSplitPortrait
                                            htmlKey:@"RC:StkMsg"];
        ...
        templateString = [self generateCommonString:NSLocalizedStringFromTable(@"RC:CardMsg", @"RongCloudKit", nil)
                                           userInfo:userInfo
                                           sentTime:model.sentTime
                                    ifSplitPortrait:ifSplitPortrait
                                            htmlKey:@"RC:CardMsg"];
        ...
        RCForwardReplace(templateString, TAG_FILENAME,
                         NSLocalizedStringFromTable(@"RC:SightMsg", @"RongCloudKit", nil));
        ...
        NSString *fileBase64 =
            [self UIImageToBase64Str:[RCKitUtility imageNamed:[RCKitUtility getFileTypeIcon:message.type]
        ...
        RCForwardReplace(templateString, TAG_FOOT, NSLocalizedStringFromTable(@"ChatHistory", @"RongCloudKit", nil));
...
- (NSMutableString *)generalTitleStyle:(NSMutableString *)templateString
    ...
    RCForwardReplace(templateString, TAG_SENDTIME, [RCKitUtility ConvertChatMessageTime:sentTime / 1000]);
    return templateString;
}
