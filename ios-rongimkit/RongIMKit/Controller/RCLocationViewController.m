...
- (void)configureNavigationBar {
    ...
    UIView *backBtn = [[UIView alloc] initWithFrame:CGRectMake(0, 6, 87, 23)];
    ...
    UITapGestureRecognizer *tap =
        [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(leftBarButtonItemPressed:)];
