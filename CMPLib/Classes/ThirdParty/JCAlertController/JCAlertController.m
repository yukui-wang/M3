...
@property (strong, nonatomic) UIImage *alertTitleIcon;
...
+ (instancetype)alertWithTitle:(NSString *)title icon:(UIImage *)icon message:(NSString *)message {
    return [self alertWithTitle:title icon:(UIImage *)icon message:message type:0];
}

+ (instancetype)alertWithTitle:(NSString *)title icon:(UIImage *)icon contentView:(UIView *)contentView {
    return [self alertWithTitle:title icon:(UIImage *)icon contentView:contentView type:0];
}

#pragma clang diagnostic pop

+ (instancetype)alertWithTitle:(NSString *)title icon:(UIImage *)icon message:(NSString *)message type:(JCAlertType)type {
    return [[self alloc] initWithTitle:title icon:(UIImage *)icon message:message type:type];
}

+ (instancetype)alertWithTitle:(NSString *)title icon:(UIImage *)icon contentView:(UIView *)contentView type:(JCAlertType)type {
    return [[self alloc] initWithTitle:title icon:(UIImage *)icon contentView:contentView type:type];
}

- (instancetype)initWithTitle:(NSString *)title icon:(UIImage *)icon message:(NSString *)message type:(JCAlertType)type{
    if (self = [super init]) {
        self.modalPresentationStyle = UIModalPresentationCustom;
        self.transitioningDelegate = self;
        self.alertTitle = title;
        self.alertTitleIcon = icon;
...
- (instancetype)initWithTitle:(NSString *)title icon:(UIImage *)icon contentView:(UIView *)contentView type:(JCAlertType)type {
    if (self = [super init]) {
        self.modalPresentationStyle = UIModalPresentationCustom;
        self.transitioningDelegate = self;
        self.alertTitle = title;
...
- (void)setupAlertView {
    ...
    self.alertView.titleImage = self.alertTitleIcon;
