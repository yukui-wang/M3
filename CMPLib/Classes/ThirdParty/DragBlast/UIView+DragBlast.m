...
-(void)dragPanAction:(UIPanGestureRecognizer*)pan{
    ...
    switch (pan.state) {
        ...
        {
            [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationName_MessageCellDragBegan object:self];
        ...
        case UIGestureRecognizerStateEnded:
        {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationName_MessageCellDragEnd object:self];
        }
            break;
