...
typedef  void (^YBLoadLocalImageFinishBlock)(YBImage *);
...
/* 图片是否保存过到我的文件 */
@property (assign, nonatomic) BOOL isSavedToMyFile;
...
@property (nonatomic, copy, nullable) YBLoadLocalImageFinishBlock loadLocalImageFinishBlock;
