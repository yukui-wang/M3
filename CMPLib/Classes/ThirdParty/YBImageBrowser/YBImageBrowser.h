...
@interface YBImageBrowser : UIViewController <CMPScreenshotControlProtocol>

/* 是否显示查看所有图片按钮 */
@property (assign, nonatomic) BOOL showCheckAllPicsBtn;
/* 融云消息数组 */
@property (copy, nonatomic) NSArray *rcImgModels;
...
/* 全部融云消息数组，包括图片和视频 */
@property (copy, nonatomic) NSArray *allRcImgModels;
/** Usually, use this array to configure data sources. Array elements can be 'YBImageBrowseCellData', 'YBVideoBrowseCellData'. */
@property (nonatomic, copy) NSArray<id<YBImageBrowserCellDataProtocol>> *allDataSourceArray;
...
@property (nonatomic, assign) BOOL isFromUC;
