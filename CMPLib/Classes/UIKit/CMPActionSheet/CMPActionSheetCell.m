...
@implementation CMPActionSheetCell
{
    CGFloat _height;
}
...
- (void)setupCMPActionSheetDefaultCellWithTitle:(NSString *)title CellHeight:(CGFloat)height
{
    _height = height;
...
- (void)setupCMPActionSheetIconAndTitleWithTitle:(NSString *)title titleFont:(UIFont *)font icon:(UIImage *)icon cellHeight:(CGFloat)height
{
    _height = height;
    _coverView.frame = CGRectMake(0, 0, ScreenWidth, _height);
