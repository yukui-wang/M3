...
@interface CMPSingleGeneralPicker ()
...
/** 选中 */
@property(nonatomic, strong) CMPSingleGeneralModel *selectModel;

@property(nonatomic, assign) NSInteger selectRow;


@property (nonatomic, strong) NSMutableArray <CMPSingleGeneralModel *>*listData;
...
@implementation CMPSingleGeneralPicker
...
-(void)buttionClick:(UIButton *)btn{
    if (btn.tag == 101) {
        CMPSingleGeneralModel *model = [CMPSingleGeneralModel new];
...
-(UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    CMPSingleGeneralModel *model = self.listData[row];
...
- (void)setDefalutOnSingleGeneraPickerView:(CMPSingleGeneralModel *)defalutModel{
    ...
    CMPSingleGeneralModel *tempProinceModel = nil;
    int index = 0;
    for (CMPSingleGeneralModel *model in self.listData) {
