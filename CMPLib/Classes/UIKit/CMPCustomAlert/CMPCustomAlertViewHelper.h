...
#define CMPAlertScreenW [UIScreen mainScreen].bounds.size.width
#define CMPAlertScreenH [UIScreen mainScreen].bounds.size.height
...
@interface CMPCustomAlertViewHelper : UIView
