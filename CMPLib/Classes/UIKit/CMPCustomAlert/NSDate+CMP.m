...
#define CMP_MONTHS_IN_A_SEASON 3 // 1季的月数

static const unsigned componentFlags = (NSCalendarUnitYear| NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekOfMonth |  NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond | NSCalendarUnitWeekday | NSCalendarUnitWeekdayOrdinal);


@implementation NSDate (CMP)
...
+ (NSDateComponents*) getComponentsOfThisSeason{
    ...
    if(thisMonth % CMP_MONTHS_IN_A_SEASON == 0){
        thisSeasonStartMonth = thisMonth - 2;
    }else{
        thisSeasonStartMonth = thisMonth - (thisMonth % CMP_MONTHS_IN_A_SEASON - 1);
    }
