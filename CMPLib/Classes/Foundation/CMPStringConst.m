...
//获取手机验证码接口
NSString * const CMPGetSMSCodeUrl = @"/rest/authentication/sms2/tel/";
//截屏上传日志接口
NSString * const CMPUploadScreenshotLog = @"/rest/m3/common/applog";
...
NSString * const CMPShareComponentTopScreenString = @"top_screen";
NSString * const CMPShareComponentUCString = @"uc";
NSString * const CMPShareComponentWechatString = @"wechat";
NSString * const CMPShareComponentWechatTimelineString = @"wechatMoments";
...
NSString * const CMPShareComponentOSSystemString = @"OSystem";
...
NSString * const CMPFileFromTypeComeFromM3 = @"file_management_from_comefrom_m3";
NSString * const CMPFileFromTypeComeFromThird = @"file_management_from_comefrom_third";
NSString * const CMPFileFromTypeSendToUC = @"file_management_from_sendto";
NSString * const CMPFileFromTypeComeFromUC = @"file_management_from_comefrom";
NSString * const CMPFileFromTypeSendToUCGroup = @"file_management_from_sendto_group";
NSString * const CMPFileFromTypeComeFromUCGroup = @"file_management_from_comefrom_group";
...
@implementation CMPStringConst

+ (BOOL)fromTypeIsUC:(NSString *)fromType {
    if ([NSString isNull:fromType]) {
        return NO;
    }
    if ([fromType isEqualToString:CMPFileFromTypeSendToUC]||
        [fromType isEqualToString:CMPFileFromTypeComeFromUC]||
        [fromType isEqualToString:CMPFileFromTypeSendToUCGroup]||
        [fromType isEqualToString:CMPFileFromTypeComeFromUCGroup]) {
        return YES;
    }
    return NO;
}
