...
UIKIT_EXTERN NSString * const CMPShareComponentTopScreenString;
UIKIT_EXTERN NSString * const CMPShareComponentUCString;
UIKIT_EXTERN NSString * const CMPShareComponentWechatString;
UIKIT_EXTERN NSString * const CMPShareComponentWechatTimelineString;
...
UIKIT_EXTERN NSString * const CMPShareComponentOSSystemString;
...
UIKIT_EXTERN NSString * const CMPFileFromTypeComeFromM3;
UIKIT_EXTERN NSString * const CMPFileFromTypeComeFromThird;
UIKIT_EXTERN NSString * const CMPFileFromTypeSendToUC;
UIKIT_EXTERN NSString * const CMPFileFromTypeComeFromUC;
UIKIT_EXTERN NSString * const CMPFileFromTypeSendToUCGroup;
UIKIT_EXTERN NSString * const CMPFileFromTypeComeFromUCGroup;
...
@interface CMPStringConst : NSObject
//判断来源于致信
