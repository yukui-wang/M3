//
//  CMPThreadSafeMutableDictionary.m
//  CMPLib
//
...
- (dispatch_queue_t)syncQueue {
    ...
    dispatch_once(&onceToken, ^{
        queue = dispatch_queue_create("com.seeyon.CMPThreadSafeMutableDictionary", DISPATCH_QUEUE_CONCURRENT);
    });
    return queue;
}
